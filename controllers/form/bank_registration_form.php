					<form class="contactForm" action="components/landlord_bank_details.php" method="post" autocomplete="off">
					...
					<div class="row">    
						<div class="col-md-12">
							<div class="form-group">
								...
								&nbsp; &nbsp;<a style="text-decoration:underline" href="landlord_profile.php">Skip</a>
							</div>
						</div>
					</div>
                    </form>